// The main program (no need to change)
...
vector<MainProgram::CmdInfo> MainProgram::cmds_ =
{
    ...
    {"places_alphabetically", "", "", &MainProgram::NoParPlaceListCmd<&Maptrip::places_alphabetically>, &MainProgram::NoParPlaceListTestCmd<&Maptrip::places_alphabetically> },
    {"places_coord_order", "", "", &MainProgram::NoParPlaceListCmd<&Maptrip::places_coord_order>, &MainProgram::NoParPlaceListTestCmd<&Maptrip::places_coord_order> },
